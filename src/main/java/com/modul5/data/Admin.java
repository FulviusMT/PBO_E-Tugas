...
import com.modul5.exception.custom.illegalAdminAccess;
import com.modul5.util.iMenu;

import java.util.Scanner;

import static com.modul5.com.main.LibrarySystem.*;
    ...
    public void menu() {
        while (true) {
            try {
                ...
                String choiceInput = scanner.nextLine(); // Menggunakan trim() untuk menghapus spasi yang tidak diinginkan
//
//                Jika inputan tidak ada isinya
