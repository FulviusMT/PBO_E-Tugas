package com.modul5.data;

import com.modul5.books.Book;
import com.modul5.util.iMenu;

import java.util.ArrayList;
import java.util.Scanner;

import static com.modul5.com.main.LibrarySystem.daftarBuku;
    ...
    public void menu() {
        ...
        while (true) {
            try {
                ...
                String pilihInput =  scanner.nextLine().trim();

                if(pilihInput.isEmpty()){
                    throw new IllegalArgumentException("Masukkanpilihan Anda");
                }

                int pilih = Integer.parseInt(pilihInput);
